...
export default function Header() {
  ...
  return (
    <header className="flex items-center justify-between w-full py-2 px-8 lg:py-1 border-b border-[var(--color-brown-light)] bg-[var(--color-background)] overflow-hidden">
      <div>
      ...
      <motion.div
        ...
        className="absolute w-0 h-screen top-0 right-0 border-l border-[var(--color-brown-light)] shadow-xl bg-[var(--color-mobile-menu-background)] z-10 overflow-hidden"
      >
